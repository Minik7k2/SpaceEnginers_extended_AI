...
namespace ZyweFrakcje
{
    ...
    public class ZyweFrakcjeSession : MySessionComponentBase
    {
        ...
        private void OnMessageEntered(string messageText, ref bool sendToOthers)
        {
            ...
            {
                sendToOthers = false;
                MyAPIGateway.Utilities.ShowMessage("ZF", "Komendy: /zf rel, /zf tick, /zf stations, /zf spawn <frakcja>, /zf raid <frakcja>, /zf okup <frakcja>, /zf kontrakt <frakcja>, /zf event <json>");
                return;
            }
